...
CREATE TABLE `bill` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
                              `purpose` varchar(50) DEFAULT NULL COMMENT '财务用途',
                              `amount` double(50,3) DEFAULT NULL COMMENT '财务金额',
                              `consume_time` datetime DEFAULT NULL COMMENT '消费时间',
                              `consumer` varchar(50) DEFAULT NULL COMMENT '消费人员',
                              `note` varchar(255) DEFAULT NULL COMMENT '描述',
                              `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                              `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                              `created_by` varchar(50) DEFAULT NULL COMMENT '创建人员',
...
-- Records of bill
-- ----------------------------
INSERT INTO `bill` VALUES ('1', '学习', '100', '2021-06-05 12:12:12','小虫', '购置图书', '2021-06-07 17:31:28', '2021-06-08 10:18:49', '崇新学堂', 'root');
INSERT INTO `bill` VALUES ('2', '拨款', '2000', '2021-03-03 02:12:12', '大新','年度拨款', '2021-06-07 17:48:06', '2021-06-08 17:48:06', '崇新学堂', 'TE00000001');
